...
import {
    getOutdatedFieldCount,
    getOutdatedTableCount,
    isWorkflowOutdated,
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        Review, customize and save your workflow. You can test your configuration against the sample
                        document.
                    </p>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {isWorkflowOutdated(workflow) && (
                            <p className="text-sm text-muted-foreground">
                                ...
                                <strong>Note:</strong> {getOutdatedFieldCount(workflow)} field(s) and{" "}
                                {getOutdatedTableCount(workflow)} table(s) have been modified. Run extraction again to
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <RefreshCw
                                className={cn(
                                    "h-4 w-4 mr-2",
                                    (isExtracting || workflow?.status === "extracting") && "animate-spin",
                                )}
                            />
