                ...
                <CardContent>
                    ...
                    {filteredExecutions.length === 0 ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-muted-foreground mb-4">{executions.length === 0 ? "No executions have been run for this workflow yet." : "No executions match your current filters."}</p>
                            {executions.length === 0 && (
                                <Button onClick={() => navigate({ to: `/workflows/${workflowId}/run` })}>
                                    <Play className="h-4 w-4 mr-2" />
                                    Run First Execution
                                        ...
                                        <TableRow key={execution.id}>
                                            ...
                                            <TableCell>
                                                <div className="text-sm">
                                                    ...
                                                    {execution.status === "completed" && execution.extractionResult && <p className="text-green-600">Extracted</p>}
                                                    {execution.status === "failed" && execution.errorMessage && <p className="text-red-600 truncate max-w-xs">{execution.errorMessage}</p>}
                                                </div>
                                            </TableCell>
