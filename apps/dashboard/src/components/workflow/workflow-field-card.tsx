...
export default function WorkflowFieldCard({
    field,
    sampleValue,
    ...
    return (
        <Card className={cn(isOutdated && "opacity-80")}>
            <CardHeader>
                <CardTitle>{isOutdated ? "" : sampleValue ? String(sampleValue) : toDisplayName(field.slug)}</CardTitle>
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isOutdated && (
                        <Badge
                            ...
                            title="This field value is outdated. Run the extraction again to see the new value."
                        >
