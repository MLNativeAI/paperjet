...
export function LoadingIndicator({ phase }: LoadingIndicatorProps) {
    ...
    return (
        <div className="text-center">
            ...
            <p className="text-lg font-medium text-blue-700">{isAnalyzing ? "Analyzing document structure..." : "Extracting data..."}</p>
            <p className="text-sm text-muted-foreground mt-2">{isAnalyzing ? "AI is identifying fields and structure in your document" : "Processing extracted data with the identified fields"}</p>
