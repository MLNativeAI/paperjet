                        ...
                        {authMethod === "social" && (
                            <>
                                <div className="flex flex-col gap-3">
                                    <Button type="button" variant="outline" className="w-full" disabled={isLoading} onClick={() => handleSocialSignUp("google")}>
                                        {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <GoogleIcon />}
                                        <span className="ml-2">Continue with Google</span>
                                    </Button>
                                    <Button type="button" variant="outline" className="w-full" disabled={isLoading} onClick={() => handleSocialSignUp("microsoft")}>
                            ...
                            <div className="flex flex-col gap-3">
                                {!magicLinkSent ? (
                                    ...
                                    <div className="text-center space-y-3">
                                        <div className="text-sm text-muted-foreground">Magic link sent! Check your email and click the link to create your account.</div>
                                        <Button
                                            type="button"
                                            variant="outline"
                                            className="w-full"
