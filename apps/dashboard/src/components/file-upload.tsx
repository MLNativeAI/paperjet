    ...
    return (
        <Card>
            <CardHeader>
                ...
                <p className="text-sm text-muted-foreground mt-1">Upload documents to process with this workflow. Supports PDF and image files.</p>
            </CardHeader>
            <CardContent className="p-0">
                ...
                >
                    ...
                    <input type="file" accept=".pdf,image/*" onChange={handleFileInput} className="hidden" id="file-input" multiple />
                    <Button asChild>
