...
import type { CategoriesConfiguration, FieldsConfiguration, TableConfiguration, Workflow } from "@paperjet/engine/types";
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {category.fields.map((field) => {
                                ...
                                return (
                                    <Card key={field.id}>
                                        <CardHeader>
                                            <CardTitle>{extractedValue?.value ? formatValue(extractedValue.value, field.type) : field.name}</CardTitle>
