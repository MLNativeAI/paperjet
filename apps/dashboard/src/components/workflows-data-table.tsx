      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant={getWorkflowStatusColor(status)}
          ...
          <div className="flex items-center gap-2">
            {isActive ? (
              <Button
                ...
                size="sm"
                onClick={() =>
                  navigate({ to: `/workflows/${row.original.id}/run` })
                }
              >
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  navigate({ to: `/workflows/${row.original.id}/finalize` })
                }
              >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-32">
                {isActive && (
                  <>
                    <DropdownMenuItem
                      onClick={() =>
                        navigate({
                          to: `/workflows/${row.original.id}/history`,
                        })
                      }
                    >
                ...
                <DropdownMenuItem
                  variant="destructive"
                  onClick={() =>
                    onDeleteWorkflow(row.original.id, row.original.name)
                  }
                >
