...
export function WorkflowAnalysisResult({
	analysis,
	fileId,
}: WorkflowAnalysisResultProps) {
	const navigate = useNavigate();
	const [workflowName, setWorkflowName] = useState(
		`${analysis.analysis.documentType} Workflow`,
	);
	const [fields, setFields] = useState<ExtractionField[]>(
		analysis.analysis.suggestedFields,
	);
	const [tables, setTables] = useState<ExtractionTable[]>(
		analysis.analysis.suggestedTables,
	);
	...
	return (
		<div className="w-full px-4 py-8 space-y-8">
			...
			<div className="text-center">
				...
				<p className="text-muted-foreground">
					Review extracted data and save your workflow.
				</p>
			</div>
