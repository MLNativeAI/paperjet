...
const faqs = [
    ...
    },
    {
        ...
        answer: "PaperJet can process virtually any document type including PDFs, images, invoices, contracts, construction blueprints, medical records, legal documents, and more. If you have a niche use case you'd like to solve, feel free to reach out to us.",
    },
    {
        question: "Can I use PaperJet for my business?",
        answer: "PaperJet is free for personal use under the AGPL v3 license. For business use, you'll need to purchase a commercial license. ",
    },
    {
        question: "What are workflows?",
        answer: "Workflows are a way to define specific extraction rules, validation steps, and output formats for different document types. It's a blueprint for how PaperJet should process your documents.",
    },
    {
        question: "What deployment options are available?",
        answer: "PaperJet can be deployed on your own infrastructure (on-premise or cloud), in isolated cloud instances, or you can use our managed service with complete data isolation. All options maintain the same privacy-first principles.",
    },
    {
