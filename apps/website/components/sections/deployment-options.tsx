...
const options = [
  {
    ...
    description: "Easily deploy PaperJet on multiple supported platforms",
    icon: <Zap className="size-5" />,
    content: (
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        <div className="flex flex-col items-center space-y-2">
          <a href="https://coolify.io" target="_blank" rel="noopener noreferrer">
            <Image alt="coolify" src="/coolify.jpg" width={48} height={48} className="size-12 rounded-lg" />
          </a>
          <span className="text-sm text-muted-foreground">Coolify</span>
        </div>
        <div className="flex flex-col items-center space-y-2">
          <a href="https://dokploy.com" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 559 446" className="size-12 rounded-lg">
              <path
          ...
          <span className="text-sm text-muted-foreground">Dokploy</span>
        </div>
        <div className="flex flex-col items-center space-y-2">
          <a href="https://aws.amazon.com/marketplace" target="_blank" rel="noopener noreferrer">
            <div className="size-12 rounded-lg bg-orange-500 flex items-center justify-center text-white font-bold">
              AWS
            </div>
          </a>
        ...
        <div className="flex flex-col items-center space-y-2">
          <a href="https://azuremarketplace.microsoft.com" target="_blank" rel="noopener noreferrer">
            <div className="size-12 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold">
              AZ
            </div>
          </a>
          <span className="text-sm text-muted-foreground">Azure Marketplace</span>
        </div>
        <div className="flex flex-col items-center space-y-2">
          <a href="https://console.cloud.google.com/marketplace" target="_blank" rel="noopener noreferrer">
            <div className="size-12 rounded-lg bg-red-500 flex items-center justify-center text-white font-bold">
              GCP
            </div>
          </a>
          <span className="text-sm text-muted-foreground">Marketplace</span>
  ...
  },
  {
    ...
    description:
      "Fully featured docker-compose setup. Perfect for just trying things out or customizing it to your needs",
    icon: <Box className="size-5" />,
    content: (
      <div className="flex justify-center">
        <div className="w-full max-w-md h-64 bg-muted rounded-lg flex items-center justify-center text-muted-foreground">
          <div className="text-center">
            {/* <p>Docker Compose Screenshot</p> */}
            <Image src="/docker-compose.png" width={500} height={500} alt="docker compose code screenshot" />
          </div>
        </div>
      </div>
    ),
  ...
  {
    title: "Helm charts",
    description: "Production-ready kubernetes deployments, including headless setup and configuration",
    icon: <Anchor className="size-5" />,
    content: (
      <div className="bg-muted rounded-lg p-4 font-mono text-sm">
        <pre className="text-muted-foreground whitespace-pre-wrap">
          {`helm repo add paperjet https://charts.paperjet.ai
helm repo update
helm install paperjet paperjet/paperjet \\
  --namespace paperjet \\
  --create-namespace`}
        </pre>
      </div>
    ...
    <section className="w-full py-20 md:py-32">
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Run it on your own terms</h2>
          <p className="max-w-[800px] text-muted-foreground md:text-lg">
            From one-click installs to Kubernetes deployments - we got you covered
          </p>
        </motion.div>
