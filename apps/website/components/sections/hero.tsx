        ...
        <section className="w-full py-20 md:py-32 lg:py-40 overflow-hidden">
            <div className="container px-4 md:px-6 relative">
                ...
                >
                    ...
                    >
                        <div className="px-3 py-1 text-xs font-medium bg-primary/10 text-primary rounded-full border border-primary/20">Launching Q3 2025</div>
                    </motion.div>
                ...
                >
                    <div className="rounded-xl overflow-hidden shadow-2xl border border-border/40 bg-gradient-to-b from-background to-muted/20">
                        <Image src="/screenshot.png" width={1280} height={720} alt="PaperJet dashboard" className="w-full h-auto" priority />
