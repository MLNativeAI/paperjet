                ...
                <Body className="bg-white my-auto mx-auto font-sans px-2">
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                        ...
                        <Section className="text-center mt-[32px] mb-[32px]">
                            <Button className="bg-[#000000] rounded text-white text-[12px] font-semibold no-underline text-center px-5 py-3" href={resetUrl}>
                                Reset Password
                            </Button>
                        </Section>
                        <Text className="text-black text-[14px] leading-[24px]">
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">This password reset link will expire in 1 hour for security reasons.</Text>
                        <Hr className="border border-solid border-[#eaeaea] my-[26px] mx-0 w-full" />
                        <Text className="text-[#666666] text-[12px] leading-[24px]">
                            This password reset request was intended for <span className="text-black">{username}</span>. If you did not request this password
                            reset, you can ignore this email. If you are concerned about your account's safety, please reach out to{" "}
