                ...
                <Body className="bg-white my-auto mx-auto font-sans px-2">
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                        <Section className="mt-[32px]">
                            <Img
                                src="https://app.cvtoblind.com/logo_cv2b.png"
                                alt="CVToBlind logo"
                        ...
                        <Text className="text-[#666666] text-[12px] leading-[24px]">
                            This password reset request was intended for <span className="text-black">{username}</span>.
                            If you did not request this password reset, you can ignore this email. If you are concerned
                            about your account's safety, please reach out to{" "}
